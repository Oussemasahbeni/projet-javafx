...
import com.esprit.hitgym.Main;
import com.esprit.hitgym.controller.auth.LogInFormController;
...
public class LoadingScreenController implements Initializable {
    ...
    class LoadingScreen extends Thread {
        public void run() {
            try {
//                CommonRepository.makeConnection();
                Thread.sleep(10000);
                ...
                if (cookie.exists()) {
                    ...
                    Platform.runLater(new Runnable() {
                        ...
                        public void run() {
                            try {
                                new LogInFormController().login(username, password);
