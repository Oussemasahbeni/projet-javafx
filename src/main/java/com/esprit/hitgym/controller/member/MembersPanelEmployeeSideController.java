...
public class MembersPanelEmployeeSideController implements Initializable {
    ...
    public MembersPanelEmployeeSideController() {
    ...
    public void loadData() throws SQLException {
        ...
        nic.setCellValueFactory(new PropertyValueFactory<>("cinNumber"));
